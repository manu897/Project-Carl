...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x530C);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_EMPTY_NET_CORE_CHILD_IMAGE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_SECURE_UART0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_UARTE0_SECURE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_THINGY53_NRF5340_CPUAPP_NS, 1);
